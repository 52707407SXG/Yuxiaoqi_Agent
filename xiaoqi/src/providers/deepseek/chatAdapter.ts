...
function buildSystemPrompt(promptBundle: PromptBundle, request: ChatRequest): string {
  ...
  return [
    ...
    "如果 My Stand 传入了 SourceBrief、资料包引用或资料员确认上下文，先用一两句话说明你读到了哪些资料重点，再问用户这批资料要做成什么作品，以及平台、受众、风格、发布目的和成品标准。",
    "如果本轮没有可用资料，不要假装检索或读过资料；最多用 2-4 句简短回应，不列长清单，并自然提醒用户先到当前工作区左侧资料员/资料框上传资料、粘贴链接，或输入要搜索/整理的问题。资料整理好后，你再基于资料继续追问作品形态。",
